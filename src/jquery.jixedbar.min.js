...
$(obj).slideToggle(defaults.slideSpeed);if(active_button_name!=""){$("#jx-menu-con-id").fadeIn();}});return false;});$("<div />").attr("id","jx-ttip-con-id").appendTo("body");$("#jx-ttip-con-id").css({"height":"auto","margin-left":"0px","width":"100%","overflow":constants["constOverflow"],"position":pos});if(defaults.showOnTop){$("#jx-ttip-con-id").css({"margin-top":$(this).height()+3,"top":constants["constBottom"]});}else{$("#jx-ttip-con-id").css({"margin-bottom":$(this).height()+3,"bottom":constants["constBottom"]});}
...
if(tooltipTitle!=""){barTooltipWrapperID=barTooltipID+"_wrapper";$("<div />").attr("id",barTooltipWrapperID).appendTo("#jx-ttip-con-id");$("<div />").attr("id",barTooltipID).appendTo("#"+barTooltipWrapperID);$("#"+barTooltipID).css({"float":"left"});if(defaults.showOnTop){$("<div />").addClass("jx-tool-point-dir-up").appendTo("#"+barTooltipID);}
$("<div />").html(tooltipTitle).addClass("jx-bar-button-tooltip").appendTo("#"+barTooltipID);if(!defaults.showOnTop){$("<div />").addClass("jx-tool-point-dir-down").appendTo("#"+barTooltipID);}
...
$("#jx-menu-con-id").addClass("jx-nav-menu");if(defaults.roundedButtons){$("#jx-menu-con-id").addClass("jx-nav-menu-rounded");}
